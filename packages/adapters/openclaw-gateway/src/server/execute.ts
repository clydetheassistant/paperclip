...
export async function execute(ctx: AdapterExecutionContext): Promise<AdapterExecutionResult> {
  ...
  // OpenClaw gateway rejects unknown root properties on agent params; the structured
  // wake payload is forwarded inside `message` (see `joinWakePayloadSections` above).
